    ...
    namespace Utils {
        namespace Hash {
            ...
            public:
                ...
                std::size_t operator() (const Math::Vector3<T>& target) const;
            };
            ...
            public:
                ...
                std::size_t operator() (const Math::Vector2<T>& target) const;
            };
            ...
            template<typename T>
            std::size_t SpatialHash3D<T>::operator()(const Math::Vector3<T> &target) const {
            ...
            template<typename T>
            std::size_t SpatialHash2D<T>::operator()(const Math::Vector2<T> &target) const {
